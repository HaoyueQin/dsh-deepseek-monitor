...
- **Balance chip**: live `Balance ¥x.xx` next to the model name; turns red below the threshold
- **Expanded panel**:
...
Tracing the reference chain upward, this project stands on:

| Project | Relationship | License |
| --- | --- | --- |
| [Joyi-code/DeepSeekMonitorWindows](https://github.com/Joyi-code/DeepSeekMonitorWindows) | Source of the ported balance/usage backend logic and dashboard structure | MIT |
| [JayHome137/DeepSeekMonitor](https://github.com/JayHome137/DeepSeekMonitor) | Upstream idea source (macOS menu-bar monitor) this lineage descends from | MIT |
| [felikschu/deepseek-monitor](https://github.com/felikschu/deepseek-monitor) | Early project referenced by DeepSeekMonitorWindows' own README: a Python web dashboard tracking DeepSeek platform changes; no code reused by this project | MIT per its README (no license file in the repo) |
